...
if(organRequest=="heart"):
    if("infect" in donor["patientCardiovascular"] donor["bloodType"]!= acceptor["bloodType"]):
...
if(organRequest=="lungs"):
    ...
    if("infect" in donor["respiratory"] or donor["smoking"]=="yes") or donor["bloodType"]!= acceptor["bloodType"]:
...
if(organRequest=="kidney"):
    ...
    if(donor["kidneyDisease"]=="yes" or donor["urine"]=="yes" or donor["bloodType"]!= acceptor["bloodType"]:
        print("Donor can't donate a lung")
        exit()
        #THIS PATIENT'S Lung IS USELESS
